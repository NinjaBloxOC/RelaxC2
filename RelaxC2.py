...
\033[0;36m                              
\033[0;36m =============FardhanX CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] Relax | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [ryuganz] | POWER : {}% [UNSTABLE]\x07".format (powerran))
